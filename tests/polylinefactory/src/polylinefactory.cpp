...
static cavc_point get_point_on_circle_by_polar_angle(cavc_real radius, cavc_point center, cavc_real angle) {
...
std::vector<cavc_vertex> PolylineFactory::createCircle(cavc_real radius, cavc_point center,
  ...
  cavc_point point1 = get_point_on_circle_by_polar_angle(radius, center, vertexRotAngle);
  cavc_point point2 = get_point_on_circle_by_polar_angle(radius, center, vertexRotAngle + PI());
